import { Controller, Get, Post, Body, Patch, Param, Delete, UseFilters, ParseIntPipe, ValidationPipe, UsePipes, UseInterceptors, UploadedFile, Res, Logger, BadRequestException } from '@nestjs/common';
...
export class EmployeeController {
  ...
  checkEmptyFile(file: Express.Multer.File) {
    if (!file) {
      throw new BadRequestException("Please select  file for upload !")
    }
  }
